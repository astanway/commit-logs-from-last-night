...
;(function($){
  ...
  $.fn.infinitescroll = function(options,callback){
    ...
    callback    = callback || function(){  ////CUSTOM: ENABLES COMMENTS FOR DISQUS
    // var disqus_shortname = 'iltp'; 
    //     (function hey() {
    //       var s = document.createElement('script'); s.async = true;
    //       s.type = 'text/javascript';
    //       s.src = 'http://disqus.com/forums/iltp/count.js'; // And here
    ...
    // define loading msg
    props.loadingMsg = $('<div id="infscr-loading" style="text-align: center; display: none; visibility: hidden;"/></div>');    
     // preload the image
